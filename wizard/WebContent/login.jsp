				...
				<div class="col-md-4 col-md-push-8">
					...
					<form action="user" class="fh5co-form animate-box" data-animate-effect="fadeInRight" method="post">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="username" placeholder="用户名/Account" name="username" autocomplete="off">
						</div>
						<div class="form-group">
							<label for="password" class="sr-only">Password</label>
							<input type="password" class="form-control" id="password" placeholder="密码/Password" name="password" autocomplete="off">
						</div>
						<div class="form-group">
							<label for="remember"><input type="checkbox" id="remember" name="remember"> 记住登录</label>
						</div>
						<div class="form-group">
							<p>没有帐号? <a href="/wizard/register.jsp">注册</a> | <a href="/wizard/forgot.jsp">忘记密码?</a></p>
						</div>
						<div class="form-group">
